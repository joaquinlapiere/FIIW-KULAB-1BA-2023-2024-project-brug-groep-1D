...
Eerst moet de "qwiic" bibliotheek geïmporteerd worden. De globale variabele "aantal_metingen" moet ook op voorhand
gedefinieërd worden en de scale opgestart worden via de qwiic.start_scale() functie

De 3 stappen (calibration..., metingen..., time_stamp_list...) moeten worden uitgevoerd voordat metingen kunnen
